...
export default function SearchForm({startPos, setStartPos, endPos, setEndPos, setCurPosSet, setWayPoints}) {
    ...
    const handleSubmit = (event) => {
        ...
        fetch('http://127.0.0.1:8000/api/find_shortest_path?start_lat=' + startPos.lat + '&start_lon=' + startPos.lng + '&end_lat=' + endPos.lat + '&end_lon=' + endPos.lng + '&min_or_max='+ max_min +'max&length_limit='+ max_dis)
